            ...
            <div class="news">
                <div class="w-1170">
                    ...
                    <div class="hot-video-list clearfix">
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=e61af2e8f87ced029e6da30027ae8a7c&action=lists&modelid=1&tagid=list_shjk_1&grade=5&typeid=53%2C54&catid=10&order=id+DESC&thumb=1&num=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('modelid'=>'1','tagid'=>'list_shjk_1','grade'=>'5','typeid'=>'53,54','catid'=>'10','order'=>'id DESC','thumb'=>'1','limit'=>'1',));}?>
                        ...
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=f5bcba93e0384e8917ee243271d21882&action=lists&modelid=1&tagid=list_shjk_2&grade=4&typeid=53%2C54&catid=10&order=id+DESC&thumb=1&num=2\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('modelid'=>'1','tagid'=>'list_shjk_2','grade'=>'4','typeid'=>'53,54','catid'=>'10','order'=>'id DESC','thumb'=>'1','limit'=>'2',));}?>
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
