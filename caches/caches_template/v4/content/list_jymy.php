            ...
            <div class="news">
                <div class="w-1170">
                    ...
                    <div class="hot-video-list clearfix">
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=c516eba8a5747f60b8a2a0781d0fd962&action=lists&modelid=1&tagid=list_jymy_1&grade=5&typeid=53%2C54%2C57%2C58&catid=11&order=id+DESC&thumb=1&thumbnum=1&num=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('modelid'=>'1','tagid'=>'list_jymy_1','grade'=>'5','typeid'=>'53,54,57,58','catid'=>'11','order'=>'id DESC','thumb'=>'1','thumbnum'=>'1','limit'=>'1',));}?>
                        ...
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=caac606fa89216111904d3d3965143f8&action=lists&modelid=1&tagid=list_jymy_2&grade=4&typeid=53%2C54&catid=11&order=id+DESC&thumb=1&thumbnum=2&num=2\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('modelid'=>'1','tagid'=>'list_jymy_2','grade'=>'4','typeid'=>'53,54','catid'=>'11','order'=>'id DESC','thumb'=>'1','thumbnum'=>'2','limit'=>'2',));}?>
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
